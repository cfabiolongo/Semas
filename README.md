...
The variable **REASONER** (in Section [REASONING]) indicates which of the integrated reasoners (HERMIT/PELLET) must be employed before query SPARQL execution in some Action's PLAN.
