...
The variable **REASONER** (in Section [REASONING]) indicates which of the integrated reasoners (HERMIT/PELLET) must be employed before each query SPARQL in every Action's PLAN.
